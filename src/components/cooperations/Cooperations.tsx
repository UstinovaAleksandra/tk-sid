		...
		<div className='cooperations' id='coop'>
			<div className='cooperations__areas'>
				...
				<div className='areas__text'>
					ТК "sid" осуществляет поставки импортного промышленного оборудования для производственных предприятий России И
					стран СНГ. Ключевыми клиентами компании являются заводы и комбинаты таких отраслей как: машиностроение,
					металлургия, металлообработка, газовая промышленность, судостроение и судоремонт, топливная промышленность,
					пищевая промышленность, перерабатывающая промышленность, химическая промышленность, ГОК, нефтехимическая
					промышленность, деревообрабатывающая промышленность, стекольная промышленность, химическая промышленность,
					ЦБК. Имея более 10-ти летний опыт работы и широкий спектр поставляемого оборудования и комплектующих, ТК "sid"
					готова решить задачу поиска, закупки и поставки оборудования практически для любой производственной
					организации.
				</div>
