		...
		<div className='cooperations' id='coop'>
			<div className='cooperations__areas'>
				...
				<div className='areas__text'>
					ТК "tk-sid" осуществляет поставки импортного промышленного оборудования для производственных предприятий
					...
					комплектующих, ТК "tk-sid" готова решить задачу поиска, закупки и поставки оборудования практически для любой
